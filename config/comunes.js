module.exports = {
	...
	MSG_ERROR_DATOS: 'Datos invalidos',
	...
	*/
	...
	Autor: Felipe Triviño
	Fecha: 05/02/2025
	Detalle: FUNCION QUE GENERA EL MENSAJE GENERICO DE ERROR CUANDO HAY DATOS INVALIDOS.
	*/
	respuestaErrorDatos(error) {
		return this.estado(this.COD_ERROR, this.MSG_ERROR_DATOS, error)
	},
